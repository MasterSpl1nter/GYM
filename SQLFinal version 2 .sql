...
CREATE TABLE IF NOT EXISTS `gym`.`class` (
    ...
    CONSTRAINT `guideid` FOREIGN KEY (`guideid`)
        REFERENCES `gym`.`guide` (`id`)
        ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `roomid` FOREIGN KEY (`room`)
...
CREATE TABLE IF NOT EXISTS `gym`.`appliance` (
    ...
    CONSTRAINT `id` FOREIGN KEY (`room`)
        REFERENCES `gym`.`room` (`id`)
        ON DELETE NO ACTION ON UPDATE NO ACTION
)  ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS `gym`.`training` (
    ...
    PRIMARY KEY (`id`),
    CONSTRAINT `appliance` FOREIGN KEY (`id`)
